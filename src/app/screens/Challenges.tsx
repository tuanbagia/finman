  ...
  return (
    <div className="bg-background relative min-h-full overflow-hidden pb-[78px]">
      ...
      <div className="relative z-10">
        ...
        <div className="px-6 sm:px-8 mb-5 flex gap-3 overflow-x-auto scrollbar-hide pb-2">
        ...
        <div className="px-6 sm:px-8 pb-24 space-y-3 max-h-[calc(100vh-450px)] overflow-y-auto scrollbar-hide">
